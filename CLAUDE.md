...
| `actions/upload-artifact@v5` + `actions/download-artifact@v5` | used in `deploy.yml` CI→deploy handoff | **Distinct from the Pages chain above.** v5 uses Node 24; v4 runs on Node 20 which GitHub forces off 2026-06-16. Do not downgrade to v4. |
## Sources
